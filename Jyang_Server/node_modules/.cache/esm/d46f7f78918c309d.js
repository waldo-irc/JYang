let fs,ShellcodeRDI,ListenerCryptoAPI;_918‍.x([["default",()=>Agents]]);_918‍.w("fs",[["default",["fs"],function(v){fs=v}]]);_918‍.w("../modules/ShellcodeRDI",[["*",null,function(v){ShellcodeRDI=v}]]);_918‍.w("../listeners/listeners_api.js",[["ListenerCryptoAPI",["ListenerCryptoAPI"],function(v){ListenerCryptoAPI=v}]]);
	...
	run(agentUUID,data) {
		...
		switch (command) {
			...
			case "connect":
				...
				let setConnectMessage = {"connect":[{"connect":{"1":remote},"fpipe": this.router.routes.smb_listener.options.PIPENAME, "connectData": construct}]};
			...
			case "injectAgent":
				...
				if (agenttype === "smb") {
					agentdll = agentdll.replace(".dll","SMB.dll");
