...
export class GoldenLayoutComponent extends React.Component {
  ...
  componentDidMount() {
    ...
    var addMenuItem = function( title, text, component, connectionPipe, communicationState ) {
      ...
      var newItemConfig = {
          ...
          component: component,
          props: { connPipe: connectionPipe, getCommState: communicationState },
      };
    ...
    addMenuItem( 'Agents Graph', 'Agents Graph', 'agents-graph-component', this.props.connPipe, this.props.getCommState );
    addMenuItem( 'HTTP Listener', 'HTTP Listener', 'http-listener-component', this.props.connPipe, this.props.getCommState );
    addMenuItem( 'SMB Listener', 'SMB Listener', 'smb-listener-component', this.props.connPipe, this.props.getCommState );
    if(!deviceIsMobile){
